//
//  PeripheralBluetoothManager.swift
//  family-coin
//
...
class PeripheralBluetoothManager: NSObject, CBPeripheralManagerDelegate {
    ...
    init(dataString: String, completition: (() -> ())) {
    ...
    func peripheralManager(peripheral: CBPeripheralManager, central: CBCentral, didSubscribeToCharacteristic characteristic: CBCharacteristic) {
        ...
        // Get the data
        dataToSend = dataString.dataUsingEncoding(NSUTF8StringEncoding)
